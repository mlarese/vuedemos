<template>
    <div class="input-group form-control datepicker-container">
        <div class="input-group-addon datepicker-label"  v-if="label">
            {{label | upperFirst}}
        </div>
        ...
        <div class="input-group-addon calendar-btn" @click="inputClick">
    ...
    export default {
        ...
        methods: {
            ...
            parse (str) {
                ...
                let res = isNaN(date.getFullYear()) ? new Date() : date;
                parsed[str] = res;
            ...
            getDateRange () {
                ...
                if (firstDayWeek > 1) {
                    ...
                    for (let i = 1; i < firstDayWeek; i++) {
                        ...
                        if(this.dateFrom){
                            if(moment(date).isBefore(this.dateFrom,'day'))      {
                                sclass = 'datepicker-item-disable'
                            }
                        }
                ...
                if (this.dateRange && this.dateRange.length < 42) {
